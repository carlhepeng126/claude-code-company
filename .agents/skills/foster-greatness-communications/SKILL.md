---
name: foster-greatness-communications
description: Create authentic, empowering marketing content, copywriting, and text-based communications for Foster Greatness. Use for email campaigns, social posts, website copy, partnership proposals, and written content. For visual design and graphics, use foster-greatness-comprehensive instead.
version: 1.1
author: Foster Greatness Communications Team
tags: [nonprofit, marketing, communications, foster-care, social-impact, brand-voice, copywriting, email, social-media]
---
...
**For visual design work, use `foster-greatness-comprehensive` instead:**
- DGW Canva graphics and social media images
- HTML/CSS layouts and branded designs
- Print materials, brochures, and visual collateral
- Logo usage, color palettes, and typography systems
